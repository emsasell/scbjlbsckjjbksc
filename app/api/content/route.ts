...
function safePublished(v:any, kind:string){ if(kind!=='news') return null; if(!v)return new Date(); const d=new Date(String(v)); if(Number.isNaN(d.getTime()))throw new Error('Некорректная дата публикации.'); return d; }
