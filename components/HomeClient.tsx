...
export default function HomeClient({content}:Props) {
 ...
 return <div className="site-shell">
  ...
  {selected&&<InfoModal item={selected} links={content.links} onClose={()=>setSelected(null)}/>} 
 </div>
}
